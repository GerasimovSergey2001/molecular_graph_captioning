...
class GNN_graphpred(torch.nn.Module):
    ...
    def from_pretrained(self, model_file, map_location=None):
        #self.gnn = GNN(self.num_layer, self.emb_dim, JK = self.JK, drop_ratio = self.drop_ratio)
        missing_keys, unexpected_keys = self.gnn.load_state_dict(torch.load(model_file, map_location=map_location))
        print(missing_keys)
